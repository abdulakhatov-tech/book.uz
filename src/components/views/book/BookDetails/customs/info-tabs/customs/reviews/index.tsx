                ...
                <li className='border-b pb-3 bg-white p-4 rounded-[8px]'>
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-2'>
                      <MdEdit onClick={() => handleUpdate(review)} className='text-[19px] text-[#5E5E5E] hover:text-gray transition-all duration-75 active:scale-[0.97]' />
                      <FaRegTrashAlt onClick={() => handleDelete(review?._id)} className='text-[16px] text-[#5E5E5E] hover:text-crimson transition-all duration-75 active:scale-[0.97]' />
                    </div>
                  </div>
