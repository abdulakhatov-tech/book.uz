      ...
      <nav>
        <ul className="flex flex-col gap-1">
          {dashboardSidebarNavigation.map(({ _id, path, Icon, label }) => (
            <li key={_id}>
              <NavLink to={path} className={({isActive}) => classNames('w-full h-[40px] flex items-center gap-3 rounded-lg px-6 font-sans hover:text-white hover:bg-[#BC8E5B] hover:font-medium', {
