      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="font-bold text-[18px] text-secondary-black">{t("dashboard.orders.full_name")}</TableHead>
            <TableHead className="font-bold text-[18px] text-secondary-black">{t("dashboard.orders.address")}</TableHead>
            <TableHead className="font-bold text-[18px] text-secondary-black">{t("dashboard.orders.created_at")}</TableHead>
            <TableHead className="font-bold text-[18px] text-secondary-black">{t("dashboard.orders.price")}</TableHead>
            <TableHead className="font-bold text-[18px] text-secondary-black">{t("dashboard.orders.status")}</TableHead>
