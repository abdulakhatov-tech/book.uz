    ...
    <TableRow>
      ...
      <TableCell>
        <div className='flex items-center gap-2'>
          <div className={classNames('flex items-center justify-center w-6 h-6 border rounded-full shadow-md transition-transform duration-200 transform hover:scale-105', {
            ...
            <div className={classNames('w-4 h-4 rounded-full shadow-inner', {
          ...
          <span className={classNames('font-semibold capitalize tracking-wide', {
