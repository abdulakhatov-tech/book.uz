			...
			<Table>
				...
				<TableHeader>
					<TableRow>
						...
						<TableHead className="font-bold text-[18px] text-secondary-black" onClick={() => handleSort("name")}>
							{t("dashboard.books.name")} <FaSort className="inline-block" />
						</TableHead>
						<TableHead className="font-bold text-[18px] text-secondary-black" onClick={() => handleSort("genre")}>
							{t("dashboard.books.genre")} <FaSort className="inline-block" />
						</TableHead>
						<TableHead className="font-bold text-[18px] text-secondary-black" onClick={() => handleSort("author")}>
							{t("dashboard.books.author")} <FaSort className="inline-block" />
						</TableHead>
						<TableHead className="font-bold text-[18px] text-secondary-black" onClick={() => handleSort("amount")}>
							{t("dashboard.books.amount")} <FaSort className="inline-block" />
						</TableHead>
						<TableHead className="font-bold text-[18px] text-secondary-black" onClick={() => handleSort("bookPrice")}>
						...
						<TableHead className="font-bold text-[18px] text-secondary-black" onClick={() => handleSort("createdAt")}>
