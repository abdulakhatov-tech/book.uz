...
const RecentlyPublishedBooks: React.FC = () => {
  ...
  return (
    <Section id="newly-published-books" className="bg-white py-[16px] sm:py-[22px] md:py-[28px]">
      <Container>
        ...
        <Carousel plugins={[Autoplay({ delay: 14000, stopOnInteraction: false })]} className="relative">
