		...
		() =>
			filteredGenres.map((item: GenreI) => (
				<NavLink
					...
					className={({ isActive }) =>
						classNames(
							"py-2 px-4 hover:bg-orange hover:text-white active:opacity-75 rounded-md text-[16px] font-normal cursor-pointer flex items-center justify-between gap-2  transition-transform duration-300 ease-in-out transform hover:scale-[0.95] hover:shadow-lg",
