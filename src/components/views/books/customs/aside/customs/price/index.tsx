...
const Price: FC = () => {
	...
	const initialFromPrice = searchParams.get("fromPrice")
		? parseInt(searchParams.get("fromPrice") as string, 10)
		: 0;
	const initialToPrice = searchParams.get("toPrice")
		? parseInt(searchParams.get("toPrice") as string, 10)
		: 1000000;
