...
const Logout: React.FC = () => {
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger>
        <div className='py-5 flex items-center gap-2 hover:text-[crimson]' aria-label={t("profile.nav.logout")}>
      ...
      <AlertDialogContent className='w-fit'>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel className="w-[50%]">{t('profile.logout.cancel')}</AlertDialogCancel>
          <AlertDialogAction 
