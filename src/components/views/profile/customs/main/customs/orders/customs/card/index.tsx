	...
	const statusStyles = useMemo(
		() =>
			classNames("px-2 py-1 rounded px-4", {
				"bg-[#CFFADB] hover:bg-[#CFFADB] text-[#05B001] hover:text-[#05B001]":
					order.status === "pending",
				"bg-[#C8DEF2] hover:bg-[#C8DEF2] text-[#107FE4] hover:text-[#107FE4]":
					order.status === "processing",
				"bg-[#E0D8F8] hover:bg-[#E0D8F8] text-[#875DFF] hover:text-[#875DFF]":
					order.status === "delivered",
				"bg-[#FFC0C0] hover:bg-[#FFC0C0] text-[#FF0000] hover:text-[#FF0000]":
