      ...
      <DialogContent className='max-w-[400px]'>
        <DialogHeader>
          ...
          <div className='flex flex-col gap-3'>
            ...
            {
              authType === "sign-in" && <DialogDescription>Telefon raqamingizni kiriting va biz sizga bir martalik SMS-kod yuboramiz </DialogDescription>
            }
            {
              authType !== "sign-in" && authType !== 'sign-up' && <DialogDescription>Telefoningizga yuborilgan bir martalik SMS-kodni kiriting</DialogDescription>
            }
          </div>
        </DialogHeader>
        <div>
