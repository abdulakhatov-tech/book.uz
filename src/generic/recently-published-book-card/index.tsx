...
const RecentlyPublishedBookCard: React.FC<BookI> = ({
	...
	return (
		<div className="grid grid-cols-[130px_1fr] sm:grid-cols-[160px_1fr] md:grid-cols-[190px_1fr] bg-secondary-blue rounded-[16px] h-full max-w-[480px]  transition-transform duration-300 ease-in-out transform hover:scale-[1.05] hover:shadow-lg">
